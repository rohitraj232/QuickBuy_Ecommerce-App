            ...
            <div className="row">
              <div className="col-12 col-md-6 col-lg-4">
                <div className="wrapper_track border border-1 mb-2 text-center rounded-3">
                  <img src="/assets/icons/free-delivery.gif" width="100" height="80" alt="icons" className="img-fluid" loading="lazy" />
              ...
              <div className="col-12 col-md-6 col-lg-4">
                <div className="wrapper_track border border-1 mb-2 text-center rounded-3">
                  <img src="/assets/icons/24-7.gif" width="100" height="80" alt="icons" className="img-fluid" loading="lazy" />
              ...
              <div className="col-12 col-md-6 col-lg-4">
                <div className="wrapper_track border border-1 mb-2 text-center rounded-3">
                  <img src="/assets/icons/money-bag.gif" alt="icons" width="100" height="80" className="img-fluid" loading="lazy" />
